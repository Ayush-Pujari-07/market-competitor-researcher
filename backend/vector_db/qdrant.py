...
class QdrantManager:
    ...
    def add_document_to_collection(
        self, collection_name: str, documents: Union[Document, List[Document]]
    ) -> bool:
        try:
    ...
    def sort_messages(
        ...
        for message in sorted_messages:
            if message["role"] == "SYSTEM":
                result_messages.append(SystemMessage(content=message["content"]))
            elif message["role"] == "ASSISTANT":
                result_messages.append(AIMessage(content=message["content"]))
            elif message["role"] == "USER":
                result_messages.append(HumanMessage(content=message["content"]))
            else:
