...
async def research_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error starting research") from e
...
async def get_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error getting report") from e
...
async def get_all_research_reports(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Error getting all research reports"
        ) from e
...
async def update_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error updating report") from e
...
async def delete_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error deleting report") from e
